...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden min-h-[calc(100vh-72px)] sm:min-h-screen">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-[1200px] mx-auto px-4 sm:px-5 py-8 sm:py-12 lg:py-16 flex flex-col items-center text-center">
        <h1 className="text-[32px] sm:text-[44px] lg:text-[56px] font-albayan font-semibold leading-tight text-black tracking-[-0.02em]">
          AI-Powered Security
          <span className="block text-[24px] sm:text-[32px] lg:text-[36px] mt-2">
